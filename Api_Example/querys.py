...
def create_prodType(db: Session, prodType: schemas.ProductType):
...
def create_product (db: Session, product: schemas.Product, store_id: int,prodType_id: int):
...
def get_prodTypes(db: Session, skip: int = 0, limit: int = 100):
